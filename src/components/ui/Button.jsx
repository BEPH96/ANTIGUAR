...
const Button = React.forwardRef(({
    ...
    const variantClasses = {
        primary: 'bg-[#193948] text-primary-foreground hover:bg-green-800',
        ...
        info: 'bg-accent text-white hover:bg-opacity-80 active:bg-opacity-100 disabled:opacity-50',
        ghost: 'hover:bg-[#193948] hover:text-white',
        link: 'bg-transparent text-primary-foreground underline hover:text-primary-600 p-0',
        outline: 'borde border-solid bg-background hover:bg-accent-500 hover:text-primary-foreground',
        text: 'bg-transparent text-primary-foreground hover:bg-surface hover:bg-opacity-50 active:bg-surface active:bg-opacity-70',
        green: 'bg-green-800 text-primary-foreground hover:bg-green-600'
    };
